...
# Introduction
Android application implementing a basic CRUD operations with Pagination
using MVVM + Dagger + Reactive Bindings for Retrofit + 
Data Binding.
...
- [Android MVVM + Dagger + Rx Retrofit + Data Binding](https://github.com/melardev/Android_MVVM_Dagger_RxRetrofit_DataBinding_Crud)
...
- [Android MVVM + Dagger + Rx Retrofit + Data Binding](https://github.com/melardev/Android_MVVM_Dagger_RxRetrofit_DataBinding_CrudPagination)
...
# TODO
- Pass more code to BaseActivity, for example the Observers should be at BaseActivity
There I assert for MainActivity.